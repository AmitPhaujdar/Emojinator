...
def create_folder(folder_name):
    if not os.path.exists(folder_name):
        os.mkdir("C:/Users/Amits study materials/"+str(folder_name))
    ...
    while True:
        ...
        if len(contours) > 0:
            ...
            if cv2.contourArea(contour) > 10000 and frames > 50:
                ...
                cv2.imwrite("gestures1/" + str(g_id) + "/" + str(pic_no) + ".jpg", save_img)
...
import pandas as pd
import os
root = './gestures1' # or ‘./test’ depending on for which the CSV is being created
